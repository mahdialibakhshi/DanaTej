                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" id="form" action="{{route('admin.tender.update',$tender->id)}} ">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="row">
                                    <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-12 mb-2">
                                                            ...
                                                            <input type="text" class="form-control" id="title_fa"
                                                                   name="title_fa" value="{{ $tender->title_fa }}">
                                                            @error('title_fa')
                                                        ...
                                                        <div class="col-md-6 mb-2 col-12 position-relative">
                                                            ...
                                                            <select  multiple="multiple" class="selectpicker form-control" name="menus_id[]" id="menu">
                                                                ...
                                                                @foreach($menus as $menu)
                                                                    <option {{in_array($menu->id,$tender->menus()->pluck('id')->all()) ? 'selected' : ''}} value="{{$menu->id}}">{{$menu->title_fa  }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-md-6 mb-2 col-12 position-relative">
                                                            ...
                                                            <select class="form-select" name="city_id" id="city">
                                                                ...
                                                                @foreach($cities as $city)
                                                                    <option style="display: none" {{$city->id == $tender->city_id ? 'selected' : ''}} data-province="{{$city->province_id}}" value="{{$city->id}}">{{$city->name  }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <textarea rows="10" type="text" class="form-control"
                                                                      id="description_fa"
                                                                      name="description_fa">{{ $tender->description_fa }}</textarea>
